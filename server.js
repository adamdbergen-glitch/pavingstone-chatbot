...
app.post("/api/internal-chat", async (req, res) => {
  try {
    ...
    // 2) Extract project meta and compute estimate if possible
    ...
    // 3) If we have an estimate, generate QuickBooks headline/description + email
    ...
    if (estimate) {
      ...
      try {
        ...
        console.error("Failed to parse INTERNAL_QB JSON:", e, fmtContent);
      }
    }
